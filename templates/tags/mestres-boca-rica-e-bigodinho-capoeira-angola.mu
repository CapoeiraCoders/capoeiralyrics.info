...
<body>
	...
	<h1 class='title'>Capoeira Angola</h1>
	<h1 class='subtitle'>Mestres Boca Rica e Bigodinho</h1>
	<img class='cover' src='/img/tags/mestres-boca-rica-e-bigodinho-capoeira-angola.jpg'></img>
	<div>
		<ul>
			{{#songs}}
				<li class="song">
